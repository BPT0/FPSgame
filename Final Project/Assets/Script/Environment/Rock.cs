...
public class Rock : MonoBehaviour
{
    ...
    [SerializeField]
    private GameObject go_effect_prepab; // 채굴 이펙트
    [SerializeField]
    ...
    private void Start()
    {
        ...
        count = _randomObj.Next(1, 5);
    }
    public void Mining()
    {
        SoundManager.instance.PlaySE(strike_Sound);
        var clone = Instantiate(go_effect_prepab, col.bounds.center, Quaternion.identity);
    ...
    private void Destruction()
    {
        ...
        Destroy(go_debris, destoryTime); // 시간 지난후 삭제됨
    }
}
